...
from report_utils import get_next_year_growth_rate, estimate_future_eps_df, estimate_future_prices, calculate_returns, get_ir_link_via_google
...
TICKER = "NVDA"
years_to_estimate = 3
discount_rate = 0.15 # the yield that we expect from the company's stock per year
